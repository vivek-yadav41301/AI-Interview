  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button  onClick={downloadPDF} className="bg-emerald-600 md:px-3 hover:bg-emerald-700 text-white py-3 text-nowrap rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base">
          Download PDF
        </button>
      </div>
